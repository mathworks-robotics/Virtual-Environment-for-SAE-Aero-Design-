    ...
    methods(Static)
        ...
        function pushJoystick(maskObj, blockPath, cfg)
            try
                ...
                Calibrated_Controller.setJoystickID( ...
                    blockPath, cfg.joystickID);
            catch
            end
        end
        ...
        function pushJoystickFromMask(maskObj, blockPath)
            try
                ...
                Calibrated_Controller.setJoystickID(blockPath, joyID);
            catch
            end
        end
        ...
        function flattenToMaskWorkspace(mws, cfg)
            ...
            mws.set('rudderMin',     cfg.rudderMin);
            mws.set('rudderMax',     cfg.rudderMax);
        end
        ...
        function loadDefaults(mws)
            ...
            mws.set('rudderMin',     -20);
            mws.set('rudderMax',     20);
        end
        ...
        function setJoystickID(blockPath, joystickID)
            ...
            if numel(joystickBlocks) ~= 1
                error('CalibratedController:JoystickBlockNotFound', ...
                    ['Expected one Simulation 3D Joystick block inside ' ...
                     '"%s", but found %d.'], blockPath, numel(joystickBlocks));
            end
            joystickNumber = ...
                Calibrated_Controller.joystickNumber(joystickID);
