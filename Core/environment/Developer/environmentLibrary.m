...
% -------------------------------------------------------------------------
%
%   Environment Source Variant Subsystem
%     Custom choice reads envCustomSource values populated from mask fields.
%     Preset choice reads envPresetSource values loaded from environmentData.sldd.
%     Both choices output latitude, longitude, elevation, and ISA deviation
%     to the shared environment physics.
%
...
%     T and rho feed the Temperature Adjusted Density subsystem. It applies
%     env.Atmosphere.ISA_Deviation_C while preserving the COESA altitude
%     profile. The speed-of-sound and pressure outputs are terminated.
%     Atmosphere.Elevation_MSL_m, Temperature_C, Pressure_Pa, and
%     Density_kgm3 remain reference metadata.
%
